...
namespace ArangoDB.Entity
{
    ...
    {
        private System.Collections.Generic.ICollection<E> edges;
        ...
        public virtual System.Collections.Generic.ICollection<E> getEdges()
        {
            return this.edges;
        }

        public virtual void setEdges(System.Collections.Generic.ICollection<E> edges)
        {
            this.edges = edges;
        }
