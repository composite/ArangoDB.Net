...
namespace ArangoDB.Model
{
    ...
    public class VertexUpdateOptions
    {
        ...
        public virtual VertexUpdateOptions keepNull(bool keepNull)
        {
        ...
        /// <returns>options</returns>
        public virtual VertexUpdateOptions waitForSync(bool waitForSync
            )
        {
        ...
        /// <returns>options</returns>
        public virtual VertexUpdateOptions ifMatch(string ifMatch)
        {
