...
namespace ArangoDB.Model
{
	...
	public class PersistentIndexOptions
    {
        ...
        protected internal IndexType type = IndexType
            .persistent;
        ...
        protected internal virtual PersistentIndexOptions fields(System.Collections.Generic.ICollection
            <string> fields)
        {
            this.fields = fields;
            return this;
        ...
        /// <returns>options</returns>
        public virtual PersistentIndexOptions unique(bool unique)
        {
            this.unique = unique;
            return this;
        }
        ...
        /// <returns>options</returns>
        public virtual PersistentIndexOptions sparse(bool sparse)
        {
            this.sparse = sparse;
            return this;
        }
