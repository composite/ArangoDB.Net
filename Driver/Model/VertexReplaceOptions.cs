...
namespace ArangoDB.Model
{
    ...
    /// <seealso><a href="https://docs.arangodb.com/current/HTTP/Gharial/Vertices.html#replace-a-vertex">API Documentation</a>
    /// 	</seealso>
    public class VertexReplaceOptions
    {
        ...
        public virtual VertexReplaceOptions waitForSync(bool waitForSync
            )
        {
        ...
        /// <returns>options</returns>
        public virtual VertexReplaceOptions ifMatch(string ifMatch)
        {
