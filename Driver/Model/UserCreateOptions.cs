...
namespace ArangoDB.Model
{
    ...
    public class UserCreateOptions
    {
        ...
        protected internal virtual string getUser()
        {
            return user;
        }
        ...
        protected internal virtual UserCreateOptions user(string user)
        {
            this.user = user;
            return this;
        }

        protected internal virtual string getPasswd()
        {
            return passwd;
        }
        ...
        /// <returns>options</returns>
        protected internal virtual UserCreateOptions passwd(string passwd
            )
        {
            this.passwd = passwd;
            return this;
        ...
        /// </param>
        /// <returns>options</returns>
        public virtual UserCreateOptions active(bool active)
        {
            this.active = active;
            return this;
        }
        ...
        /// <returns>options</returns>
        public virtual UserCreateOptions extra(System.Collections.Generic.IDictionary
            <string, object> extra)
        {
            this.extra = extra;
            return this;
