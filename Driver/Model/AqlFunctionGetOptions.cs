...
namespace ArangoDB.Model
{
    ...
    public class AqlFunctionGetOptions
    {
        ...
        /// <param name="namespace">Returns all registered AQL user functions from namespace namespace
        /// 	</param>
        /// <returns>options</returns>
        public virtual AqlFunctionGetOptions @namespace(string @namespace
            )
        {
