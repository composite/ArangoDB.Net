...
namespace VelocyPack
{
    ...
    public interface IVPackDeserializer
    {
        object Deserialize(VPackSlice parent, VPackSlice vpack, VPackDeserializationContext context);
    }

    /// <author>Mark - mark at arangodb.com</author>
	public abstract class VPackDeserializer<T> : IVPackDeserializer
    {
